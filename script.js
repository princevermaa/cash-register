...
let displayCid = document.getElementById("cid-text");
...
document.getElementById("price-text").innerHTML = `<b>Price:</b> ${price}`;
...
purchaseBtn.addEventListener("click", checkFunds);
